...
A data.table named `tidy_data` is set with the following columns.  All units are maintained from the original data set. A file named tidy_data.txt is written from run_analysis.R.
